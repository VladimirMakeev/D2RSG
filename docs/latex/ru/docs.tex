...
\author{mak}
\title{\selectlanguage{Russian}Генератор случайных сценариев Disciples 2\\Документация для версии 0.5.0}
...
\fancyhead[RO,RE]{\textcolor{gray}{Версия генератора 0.5.0}}
