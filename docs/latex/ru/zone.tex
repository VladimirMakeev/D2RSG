...
\item \texttt{resourceMarkets} - список рынков. См. \hyperref[resourcemarket]{\selectlanguage{Russian}Рынок ресурсов}
...
\item \texttt{border} - тип границ зоны. По умолчанию зона имеет непроходимые границы. См. \hyperref[borderTypes]{\selectlanguage{Russian}Типы границ зон}
